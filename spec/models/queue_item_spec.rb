...
describe QueueItem do
  ...
  describe "#video_title" do
    it "returns the title of the associated video" do
      video = Fabricate(:video, title: "Random")
      queue_item = Fabricate(:queue_item, video: video)
      expect(queue_item.video_title).to eq("Random")
    end
  end

  describe "#rating" do
    it "returns the rating from the review when review exists" do
  ...
  describe "#rating=" do
    it "changes the rating of hte review if review exists" do
      user = Fabricate(:user)
      video = Fabricate(:video)
    ...
    it "clears the rating of the review if review exists" do
      user = Fabricate(:user)
      video = Fabricate(:video)
      review = Fabricate(:review, user: user, video: video, rating: 2)
      queue_item = Fabricate(:queue_item, user: user, video: video)
